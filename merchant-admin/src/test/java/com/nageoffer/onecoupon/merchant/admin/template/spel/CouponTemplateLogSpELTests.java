...
package com.kongji.onecoupon.merchant.admin.template.spel;

import cn.hutool.core.lang.Assert;
import com.kongji.onecoupon.merchant.admin.common.context.UserContext;
import com.kongji.onecoupon.merchant.admin.common.context.UserInfoDTO;
...
public class CouponTemplateLogSpELTests {
    ...
    public void testSpELGetCurrentUser() {
        ...
        // 调用用户上下文获取当前用户 ID
        String spELKey = "T(com.kongji.onecoupon.merchant.admin.common.context.UserContext).getUserId()";
        ExpressionParser parser = new SpelExpressionParser();
        Expression expression = parser.parseExpression(spELKey);
        try {
    ...
    public void testSpELGetCurrentUserDefaultValue() {
        ...
        String spELKey = "T(com.kongji.onecoupon.merchant.admin.common.context.UserContext).getUserId() ?: 'ding.ma'";
        ExpressionParser parser = new SpelExpressionParser();
        Expression expression = parser.parseExpression(spELKey);
